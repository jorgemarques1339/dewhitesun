...
export default function ShopPage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      ...
      if (error) {
        ...
        // Extrair categorias únicas automaticamente da base de dados
  ...
  // 2. Lógica de Filtragem (Corre sempre que pesquisa ou categoria mudam)
  useEffect(() => {
    let result = products;
    ...
    <div className="min-h-screen bg-slate-50 pb-24">
      ...
      <div className="pt-32 px-4 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <span className="text-gold-500 uppercase tracking-widest text-xs font-bold">
            Catálogo Completo
          </span>
        ...
        <div className="mb-8 flex flex-col md:flex-row gap-4 justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-slate-100 sticky top-24 z-30">
          ...
          <div className="relative w-full md:max-w-md">
            ...
            <input 
              ...
              className="w-full pl-10 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand transition-all text-sm text-ocean-950"
            />
            {searchQuery && (
              <button 
          ...
          {/* Lista de Categorias (Scroll Horizontal no Mobile) */}
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex justify-between items-center border-t border-slate-50 pt-3">
                        ...
                        <button 
                          onClick={(e) => {
                            e.preventDefault(); // Impede de abrir a página do produto
                            addToCart(product);
                            // Opcional: Adicionar um toast/notificação aqui
                          }}
